...
class Review:
    ...
    def instance_from_db(cls, row):
        ...
        Reuse cached object if exists, otherwise create new.
        """
    ...
    def employee_id(self, value):
        """
        Must reference an existing Employee record.
        """
        ...
        if not emp:
            raise ValueError("Employee must already exist in the database.")
